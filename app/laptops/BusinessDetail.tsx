...
export default function BusinessDetail({ product, slug }: { product: GamingLaptop; slug: string }) {
  ...
  return <main className="detailPage">
    <header className="detailHeader">
      ...
      <nav><a href="/">Home</a><a href="/laptops">Laptops</a><a href="/#about">OEM / ODM</a><a href="/#factory">Factory</a></nav>
    ...
    <section className="detailBottomCta"><p>LOW MOQ · OEM / ODM · FACTORY DIRECT</p><h2>Ready to source your<br /><span>laptop platform?</span></h2><a href={inquiry} target="_blank" rel="noreferrer">Ask for {product.code} specifications on WhatsApp ↗</a></section>
  </main>;
}
